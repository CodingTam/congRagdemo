...
class HybridSearch:
    ...
    def __init__(self, vector_store, embedder):
        ...
        self.documents = []
        self.metadata_list = []
        self.document_ids = []  # Store document IDs for reference
    ...
    def build_keyword_index(self):
        ...
        try:
            ...
            self.document_ids = all_data["ids"]  # Store IDs for reference
    ...
    def semantic_search(self, query_embedding: List[float], top_k: int = 10) -> Dict:
        ...
        """
        try:
            # Use vector_store's query method which returns ChromaDB-compatible format
    ...
    def _combine_results(self, semantic_results: Dict, keyword_results: List[Tuple[int, float]],
        ...
        for idx, keyword_score in keyword_results:
            if idx < len(self.documents) and idx < len(self.document_ids):
                # Use stored document ID
